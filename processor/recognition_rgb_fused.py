...
class REC_Processor(Processor):
    ...
    def load_model(self):
        self.model = self.io.load_model(self.arg.model,
                                        **(self.arg.model_args))
        print(f"Load teacher model: {self.arg.teacher_model}")
        self.model.stgcn = self.io.load_model(self.arg.teacher_model,
                                              **(self.arg.stgcn_args))
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--teacher_model', default='models.stgcn.Model', help='the model architecture of teacher gcn')
        parser.add_argument('--temporal_positions', default=None, help='temporal positions for calculating the joint weights')
        parser.add_argument('--stgcn_args', action=DictAction, default=dict(), help='the arguments of model stgcn')
